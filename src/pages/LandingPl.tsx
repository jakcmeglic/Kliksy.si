...
const EVENT_TYPES = [
  { word: "Waszego wesela" },
  { word: "Waszego wydarzenia" },
  { word: "Waszego przyjęcia" }
];
...
const REVIEWS = [
  ...
  {
    name: "Zespół firmowy", date: "Grudzień 2025",
    text: "W końcu udokumentowaliśmy naszą imprezę świąteczną w jednym miejscu. Jako technicy bardzo chwalimy prostotę. Skanuj i fotografuj. Bez zakładania kont użytkowników.",
...
const FAQS = [
  { q: "Czy goście potrzebują aplikacji?", a: "Nie! Kliksy działa całkowicie w przeglądarce na telefonie. Goście po prostu skanują kod QR swoim aparatem i mogą od razu dodawać zdjęcia – bez pobierania i bez rejestracji." },
  { q: "Czy działa to również bez internetu?", a: "Aby dodać zdjęcia, goście potrzebują połączenia z internetem (danych mobilnych lub Wi-Fi na wydarzeniu). Możesz przeglądać i korzystać z galerii, kiedy tylko jesteś online." },
  { q: "Jak długo mam dostęp do galerii?", a: "W zależności od wybranego pakietu. W pakiecie Basic jest to 1 miesiąc, w Plus 1 rok, a w pakiecie Premium 2 lata. W tym czasie możesz pobrać wspomnienia w dowolnym momencie." },
  { q: "Czy galeria jest prywatna?", a: "Tak, Twoja galeria jest w 100% privatna. Dostęp do niej mają tylko osoby, którym wyślesz link, oraz goście, którzy zeskanowali kod QR." },
  { q: "Co jeśli mam więcej wydarzeń?", a: "W panelu administracyjnym (dashboardzie) możesz dodawać nowe wydarzenia i mieć wszystkie wydarzenia zebrane na swoim profilu." }
];
    ...
    <div className="min-h-screen bg-[#FDFCFB] selection:bg-indigo-100 selection:text-indigo-900 font-sans text-gray-900 overflow-x-hidden">
      ...
      <nav className="fixed w-full top-0 z-50 bg-[#FDFCFB]/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-[1280px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10 text-[15px] font-semibold text-gray-600">
            <a href="#kako-deluje" className="hover:text-gray-900 transition-colors">Jak to działa</a>
            <a href="#prednosti-dodatne" className="hover:text-gray-900 transition-colors">Dlaczego tego potrzebujesz</a>
            <a href="#paketi" className="hover:text-gray-900 transition-colors">Cennik</a>
            <a href="#mnenja" className="hover:text-gray-900 transition-colors">Opinie</a>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {user && !user.isAnonymous ? (
              <Link to="/dashboard" className="flex shrink-0 items-center justify-center w-10 h-10 rounded-full bg-indigo-50 text-indigo-600 border border-indigo-100 hover:ring-2 hover:ring-indigo-500 hover:ring-offset-2 transition-all">
                {user.photoURL ? (
                  <img src={user.photoURL} alt="Profil" className="w-full h-full object-cover rounded-full" referrerPolicy="no-referrer" />
                ) : (
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col py-4 px-6 space-y-4 text-center text-[16px] font-semibold text-gray-700">
                <a href="#kako-deluje" onClick={() => setIsMobileMenuOpen(false)} className="py-2 hover:text-indigo-600">Jak to działa</a>
                <a href="#prednosti-dodatne" onClick={() => setIsMobileMenuOpen(false)} className="py-2 hover:text-indigo-600">Dlaczego tego potrzebujesz</a>
                <a href="#paketi" onClick={() => setIsMobileMenuOpen(false)} className="py-2 hover:text-indigo-600">Cennik</a>
                <a href="#mnenja" onClick={() => setIsMobileMenuOpen(false)} className="py-2 hover:text-indigo-600">Opinie</a>
                ...
                {!user || user.isAnonymous ? (
                  <div className="pt-4 flex flex-col gap-3">
                    <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="w-full bg-purple-50 text-purple-700 py-3 rounded-xl font-bold flex items-center justify-center gap-2">
                       Zaloguj się <UserIcon className="w-5 h-5"/>
                    </Link>
        ...
        <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-8">
          ...
          <div className="w-full md:w-[55%] lg:w-1/2 px-2 md:px-0 text-center md:text-left">
            ...
            <h1 className="text-[2.5rem] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[4.5rem] font-extrabold tracking-tight text-gray-900 mb-4 leading-[1.05] break-words min-h-[160px] md:min-h-0 flex flex-col justify-start md:block">
              <span className="block">Nie trać zdjęć</span>
            ...
            <p className="text-lg md:text-xl text-gray-500 mb-10 max-w-lg mx-auto md:mx-0 leading-relaxed font-medium">
              Z Kliksy zbierzesz wszystkie zdjęcia i filmy gości w jednym miejscu, za pomocą tylko jednego kodu QR.
            </p>
            ...
            <div className="flex flex-col items-center md:items-start gap-4">
              <Link to="/create" onClick={() => { if (typeof window !== 'undefined' && window.fbq) { window.fbq('track', 'AddToCart'); } }} className="inline-flex items-center justify-center gap-3 bg-[#5B45FF] text-white px-8 py-4 rounded-full text-[17px] font-bold hover:bg-[#4E3BE0] transition-all shadow-xl shadow-[#5B45FF]/30 hover:shadow-2xl hover:scale-[1.02] active:scale-95 text-center w-[90%] mx-auto md:mx-0 sm:w-auto">
                Stwórz swoją galerię teraz <ArrowRight className="w-5 h-5" />
              </Link>
              <div className="flex items-center justify-center md:justify-start gap-2 text-[13px] md:text-[14px] font-semibold text-green-600">
                ...
                <span>Bezpiecznie. Prywatnie. Tylko dla Was i Waszych gości.</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-[45%] lg:w-1/2 relative lg:h-[500px] flex items-center justify-center md:justify-end mt-12 md:mt-0">
             <div className="relative w-full max-w-[600px] right-0 lg:-mr-16">
                ...
                <div className="absolute -top-4 right-4 sm:-right-8 lg:-right-4 z-20 bg-white px-5 py-3 rounded-[24px] shadow-xl flex items-center gap-3 border border-gray-100">
                  ...
                  <div>
                    <p className="text-[14px] font-extrabold flex items-center gap-1.5 text-gray-900">Zabawa na weselu <Heart className="w-4 h-4 text-red-500 fill-red-500"/></p>
                    <p className="text-[13px] text-gray-500"><strong className="text-gray-900">+183</strong> nowych zdjęć</p>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-8 -left-4 sm:-left-8 lg:-left-4 z-20 bg-white p-4 rounded-[28px] shadow-xl flex items-center gap-4 border border-gray-100">
                  ...
                  <div className="pr-2">
                    <p className="text-[15px] font-bold leading-tight text-gray-900">Zeskanuj<br/>kod QR</p>
                  </div>
                </div>
             </div>
          </div>
        ...
        <div className="bg-white rounded-[2rem] px-6 sm:px-8 py-8 md:py-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-50 flex-col items-stretch">
          ...
          <div className="flex flex-row items-center gap-4 sm:gap-5 w-full md:w-auto mt-2 md:mt-0 justify-start">
            ...
            <div className="text-left">
              ...
              <p className="text-[14px] sm:text-[15px] font-semibold text-gray-600 leading-tight">osób wybrało już Kliksy</p>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center gap-4 sm:gap-5 w-full md:w-auto justify-start">
             ...
             <div className="text-left">
               ...
               <p className="text-[14px] sm:text-[15px] font-semibold text-gray-600 mb-1 leading-none pt-1">na podstawie pierwszych ocen</p>
          ...
          <div className="flex flex-row items-center gap-4 sm:gap-5 w-full md:w-auto justify-start">
             ...
             <div className="text-left">
               ...
               <p className="text-[14px] sm:text-[15px] font-semibold text-gray-600 leading-tight">zebranych zdjęć i filmów</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="pb-16 pt-8 bg-[#FDFCFB]">
        <div className="max-w-[1200px] mx-auto px-6">
          <h2 className="text-[32px] md:text-[40px] font-extrabold text-center mb-16 text-gray-900 tracking-tight">Dlaczego tego potrzebujesz?</h2>
          <div className="grid md:grid-cols-3 gap-6 md:gap-10">
            <div className="flex flex-row md:flex-col items-start gap-4 sm:gap-5 p-0 sm:p-6 mb-6 md:mb-0">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900 leading-tight">Fotograf nie może być wszędzie</h3>
                 <p className="text-gray-500 font-medium text-[15px] md:text-[16px] leading-relaxed">Goście uwieczniają spontaniczne chwile, które profesjonalny fotograf często przegapia.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start gap-4 sm:gap-5 p-0 sm:p-6 mb-6 md:mb-0">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900 leading-tight">Zdjęcia inaczej przepadną</h3>
                 <p className="text-gray-500 font-medium text-[15px] md:text-[16px] leading-relaxed">Zdjęcia pozostają na telefonach, w czatach i nigdy ich nie otrzymujesz.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start gap-4 sm:gap-5 p-0 sm:p-6 mb-2 md:mb-0">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900 leading-tight">Wspomnienia z każdej perspektywy</h3>
                 <p className="text-gray-500 font-medium text-[15px] md:text-[16px] leading-relaxed">Otrzymujesz całą historię swojego dnia, widzianą oczami Twoich gości.</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-[#FDFCFB]">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <Link to="/create" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-[#5B45FF] text-white px-8 py-4 rounded-full text-[17px] font-bold hover:bg-[#4E3BE0] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#5B45FF]/30">
            Zacznij zbierać wspomnienia <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
      ...
      <section id="kako-deluje" className="py-24 bg-[#FDFCFB] relative text-center">
        <h2 className="text-[36px] md:text-[44px] font-extrabold mb-20 text-gray-900 tracking-tight">Jak to działa?</h2>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-16 md:gap-8 relative">
            ...
            <div className="relative z-10 flex flex-col items-center">
               ...
               <h3 className="text-[20px] font-extrabold mb-3 text-gray-900">Wydrukuj kod QR</h3>
               <p className="text-gray-500 font-medium px-4 mb-10 leading-relaxed text-[16px] md:min-h-[80px]">
                 Wydrukuj kod QR i umieść go na stołach, przy wejściu lub w dowolnym miejscu na wydarzeniu.
               </p>
            ...
            <div className="relative z-10 flex flex-col items-center">
               ...
               <h3 className="text-[20px] font-extrabold mb-3 text-gray-900">Goście robią zdjęcia i udostępniają</h3>
               <p className="text-gray-500 font-medium px-4 mb-10 leading-relaxed text-[16px] md:min-h-[80px]">
                 Goście skanują kod QR i natychmiast zaczynają dodawać swoje zdjęcia i filmy – bez logowania.
               </p>
               <div className="mt-auto w-full max-w-[280px] bg-white rounded-[2.5rem] overflow-hidden shadow-[0_20px_40px_-15px_rgba(0,0,0,0.2)] mx-auto border-[10px] border-gray-900 relative">
                 {LANDING_IMAGES.guestTakingPhoto ? (
                   ...
                   <div className="w-full h-[360px] p-6 pt-12 flex flex-col bg-white">
                    ...
                    <div className="bg-gray-900 text-white p-4 rounded-full text-center font-bold mb-4 shadow-xl">Wybierz z galerii</div>
                    <div className="text-center text-sm font-bold text-gray-400 mb-4">lub</div>
                    <div className="bg-gray-100 text-gray-600 p-4 rounded-full text-center font-bold">Zrób zdjęcie aparatem</div>
                   </div>
                 )}
            ...
            <div className="relative z-10 flex flex-col items-center">
               ...
               <h3 className="text-[20px] font-extrabold mb-3 text-gray-900">Wszystko w jednym miejscu</h3>
               <p className="text-gray-500 font-medium px-4 mb-10 leading-relaxed text-[16px] md:min-h-[80px]">
                 Wszystkie zdjęcia i filmy są zbierane w Twojej prywatnej galerii, którą po wydarzeniu możesz pobrać jednym kliknięciem.
               </p>
               <div className="mt-auto w-full max-w-[280px] bg-white rounded-[2rem] overflow-hidden shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-gray-100 p-5 flex flex-col mx-auto h-[360px]">
                 <div className="flex justify-between items-center mb-5">
                   <div className="text-left">
                     <p className="text-[14px] font-extrabold text-gray-900">Cała kolekcja</p>
                     <p className="text-[#5B45FF] font-bold text-[11px] mt-1 pt-1 opacity-80">182 zdjęcia • 24 filmy</p>
                   </div>
                   <div className="px-3 py-1.5 border-2 border-indigo-50 rounded-full">
                     <p className="text-[#5B45FF] font-bold text-[11px]">Pobierz wszystko</p>
                   </div>
                 </div>
      ...
      <section className="py-8 bg-[#FDFCFB]">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <Link to="/create" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-[#5B45FF] text-white px-8 py-4 rounded-full text-[17px] font-bold hover:bg-[#4E3BE0] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#5B45FF]/30">
            Stwórz swoje wydarzenie teraz <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
      ...
      <section id="prednosti-dodatne" className="py-24 bg-[#FDFCFB]">
        <div className="max-w-[1200px] mx-auto px-6">
          <h2 className="text-[32px] md:text-[44px] font-extrabold mb-12 md:mb-20 text-gray-900 tracking-tight text-center">Dlaczego warto wybrać Kliksy?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 md:gap-y-16 gap-x-12">
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">Lepsze niż fotobudka</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Bez limitów, bez rekwizytów i czekania w kolejce. Goście fotografują wszystko, co chcą.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">Wszystkie zdjęcia w jednym miejscu</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Koniec z szukaniem w telefonach i czatach. Wszystko jest uporządkowane w jednym miejscu.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">Natychmiastowy dostęp</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Już w trakcie wydarzenia widzisz nowe treści. Idealne do dzielenia się z gośćmi.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">100% prywatności</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Galeria jest przeznaczona tylko dla Ciebie i Twoich wybranych gości. Bez publicznych linków.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">Pełna jakość</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Zdjęcia i filmy są zapisywane w oryginalnej jakości. Bez kompresji i utraty jakości.</p>
               </div>
            </div>
            ...
            <div className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center">
               ...
               <div>
                 <h3 className="font-extrabold text-[18px] md:text-[20px] mb-1.5 md:mb-3 text-gray-900">Zabawa dla każdego</h3>
                 <p className="text-gray-500 font-medium leading-relaxed text-[15px] md:text-[16px]">Proste dla wszystkich pokoleń – od dzieci po babcie i dziadków.</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section id="mnenja" className="py-24 bg-white relative">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          <h2 className="text-[32px] md:text-[44px] font-extrabold mb-12 md:mb-16 text-center text-gray-900 tracking-tight">Opinie naszych klientów</h2>
      ...
      <section id="paketi" className="py-24 bg-[#FDFCFB] relative">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-16 md:mb-20 relative flex flex-col items-center">
            <h2 className="text-[36px] md:text-[44px] font-extrabold mb-4 text-gray-900 tracking-tight">Proste pakiety</h2>
            <p className="text-[15px] md:text-[16px] text-gray-500 font-medium mb-6">Wybierz pakiet, który najlepiej pasuje do Twojego wydarzenia.</p>
            ...
            <div className="bg-white p-8 md:p-10 rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col relative overflow-hidden">
              ...
              <ul className="space-y-4 mb-10 flex-1">
                {[
                  ...
                  'Do 50 gości', 
                  'Do 200 zdjęć', 
                  'Dostęp do galerii przez 1 miesiąc',
          ...
          <div className="mt-12 flex items-center justify-center gap-2 text-[14px] text-gray-500 font-medium">
             <Shield className="w-5 h-5 text-gray-400" /> 30-dniowa gwarancja zwrotu pieniędzy – bez pytań.
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="py-24 bg-white relative">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-[36px] md:text-[44px] font-extrabold mb-16 text-center text-gray-900 tracking-tight">Najczęściej zadawane pytania</h2>
      ...
      <section className="py-12 px-4 sm:px-6 bg-white">
        <div className="max-w-[1280px] mx-auto bg-[#1C1F26] rounded-[2rem] sm:rounded-[2.5rem] pt-12 px-6 pb-0 md:pt-20 md:px-20 text-center relative flex flex-col items-center shadow-2xl overflow-hidden">
            <h2 className="text-[32px] sm:text-[36px] md:text-[44px] font-extrabold mb-4 sm:mb-6 text-white tracking-tight leading-[1.1] relative z-10">Czy jesteście gotowi na<br/>zbieranie wspomnień?</h2>
            <p className="text-[15px] sm:text-[17px] text-gray-400 mb-8 sm:mb-10 max-w-lg mx-auto font-medium leading-relaxed relative z-10">
              Stwórzy swoją galerię i nie trać żadnego zdjęcia ze swojego wyjątkowego dnia.
            </p>
          ...
          <div className="relative w-full flex justify-center gap-3 sm:gap-6 px-4 pb-0 -mb-8 sm:-mb-12 mt-4 z-0">
             <img src="https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&q=80&w=300" className="w-[100px] sm:w-[180px] h-[120px] sm:h-[200px] object-cover rounded-xl shadow-2xl transform rotate-[-4deg] translate-y-4" alt="Wspomnienia z imprezy" />
             <img src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&q=80&w=300" className="w-[120px] sm:w-[220px] h-[140px] sm:h-[240px] object-cover rounded-xl shadow-2xl z-10" alt="Wspaniałe wspomnienia" />
             <img src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&q=80&w=300" className="w-[100px] sm:w-[180px] h-[120px] sm:h-[200px] object-cover rounded-xl shadow-2xl transform rotate-[4deg] translate-y-4" alt="Przyjaciele" />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white pt-16 pb-8 border-t border-gray-100">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-8 mb-16">
            <div className="md:col-span-5 lg:col-span-4 pr-8">
              ...
              <p className="text-gray-500 leading-relaxed font-medium text-[15px] max-w-sm">
                Zbieranie wspomnień nigdy nie było tak proste.
              </p>
            </div>
            <div className="md:col-span-2 lg:col-span-2">
              <h4 className="font-extrabold text-gray-900 mb-6 text-[15px]">Linki</h4>
              <ul className="space-y-4 text-gray-500 font-medium text-[15px]">
                <li><a href="#kako-deluje" className="hover:text-gray-900 transition-colors">Jak to działa</a></li>
                <li><a href="#paketi" className="hover:text-gray-900 transition-colors">Pakiety</a></li>
                <li><a href="#mnenja" className="hover:text-gray-900 transition-colors">Opinie</a></li>
                <li><a href="#faq" className="hover:text-gray-900 transition-colors">FAQ</a></li>
              </ul>
            </div>
            <div className="md:col-span-2 lg:col-span-2">
              <h4 className="font-extrabold text-gray-900 mb-6 text-[15px]">Kwestie prawne</h4>
              <ul className="space-y-4 text-gray-500 font-medium text-[15px]">
                <li><Link to="/pogoji-uporabe" className="hover:text-gray-900 transition-colors">Regulamin</Link></li>
                <li><Link to="/zasebnost" className="hover:text-gray-900 transition-colors">Polityka prywatności</Link></li>
                <li><Link to="/piskotki" className="hover:text-gray-900 transition-colors">Pliki cookies</Link></li>
              </ul>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-100 text-[13px] text-gray-400 font-medium gap-6">
            ...
            <p className="order-1 md:order-2">© {new Date().getFullYear()} Kliksy. Wszelkie prawa zastrzeżone.</p>
