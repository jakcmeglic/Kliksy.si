  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-gray-900 pb-20">
      <div className="max-w-3xl mx-auto px-6 pt-12 md:pt-20">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-8">Uvjeti korištenja</h1>
        ...
        <div className="prose prose-lg text-gray-600">
          ...
          <p className="mb-6">Uvjeti korištenja pričnejo veljati z dnem objave. Upravljavec si pridržuje pravico do spremembe pogojev, o čemer se uporabnike pravočasno seznani.</p>
        </div>
      </div>
    </div>
  );
