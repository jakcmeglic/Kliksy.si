  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-gray-900 pb-20">
      <div className="max-w-3xl mx-auto px-6 pt-12 md:pt-20">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-8">Politika piškotkov</h1>
        ...
        <div className="prose prose-lg text-gray-600">
          ...
          <p className="mb-6">Piškotki so manjše besedilne datoteke, ki se shranijo na vašo napravo, ko obiščete našo spletno stran. Omogočajo prepoznavanje naprave in si »zapomnijo« vaše določene izbire (kot so prijava v sistem ali izbrani paket).</p>
